...
// RBD-01..RBD-16 (the full rb_delete test plan) now live in
// tests/test_delete.c, split out the same way tests/test_insert.c already
// stands alone for rb_insert.
